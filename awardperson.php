...
$sql = "SELECT person.personname, person.surname
            FROM award, awardtoperson, person
            WHERE person.personid = awardtoperson.personid
            AND awardtoperson.awardid = award.awardid
            AND award.awardname ='$moviename'";
...
if($count==0) {
    echo "<div>No person found that won: $moviename</div>";
}
else {
echo "<h1>People who won $moviename</h1>"
?>
